...
(function(exports) {
	...
	function Frame(g) {
		var sf = stackHelper.getStackFrame(g);
		this.name = sf.functionName;
		this.file = sf.scriptName;
		this.line = sf.lineNumber;
